#Project Overview: This project demonstrates data transformation techniques to clean and 
...
Tools Used: Power BI Desktop, Power Query, MS SQL Server, Excel, CRM (Reapit/Capita) 
data exports. 
